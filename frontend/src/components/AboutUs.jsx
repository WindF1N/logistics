...
const aboutUsItems = [
  {
    title: "Торгівля — вигідні рішення для вашого бізнесу",
    description: "Ми надаємо повний спектр послуг у сфері торгівлі: від аналізу ринку до супроводу угод. Співпраця з провідними постачальниками дозволяє нам гарантувати якісні товари за конкурентними цінами. Ми допомагаємо оптимізувати закупівлі та спрощуємо взаємодію з партнерами.",
    listItems: [
  ...
  {
    title: "Логістика під ключ — точність і надійність",
    description: "Ми розробляємо оптимальні маршрути, враховуючи терміни та специфіку ваших вантажів. Наша команда забезпечує повне супроводження на кожному етапі доставки, від відправлення до отримання. Прозорість процесів і контроль термінів — основа нашої логістики.",
    listItems: [
  ...
  },
  {
    ...
    description: "Ми об'єднуємо вантажі від різних відправників в єдину партію для оптимізації перевезень. Це дозволяє знизити вартість доставки та скоротити час очікування. Наші фахівці стежать за безпекою та збереженням вашого вантажу на всіх етапах транспортування.",
    listItems: [
